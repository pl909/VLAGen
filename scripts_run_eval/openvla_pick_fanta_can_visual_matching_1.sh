...
declare -a arr=("/home/pl217/fantadistractornew")
...
env_name=GraspSingleOpenedFantaCanDistractorInScene-v0
...
do CUDA_VISIBLE_DEVICES=3,4 python simpler_env/main_inference.py --policy-model openvla --ckpt-path ${ckpt_path} \
