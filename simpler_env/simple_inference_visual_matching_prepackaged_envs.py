...
Example:
    ...
    CUDA_VISIBLE_DEVICES=2,3 python simpler_env/simple_inference_visual_matching_prepackaged_envs.py --policy openvla/openvla-7b \
    --ckpt-path None --task widowx_stack_cube  --logging-root ./results_simple_eval/  --n-trajs 10
...
for ep_id in range(args.n_trajs):
    ...
    is_final_subtask = base_env.is_final_subtask()
