...
LLM_BACKBONES = {
    "phi-2-3b": {"cls": LLMBackbone, "kwargs": {}},
    "llama2-7b-pure": {"cls": LLMBackbone, "kwargs": {}},
}
...
def get_llm_backbone_and_tokenizer(
    llm_backbone_id: str,
    **kwargs
) -> Tuple[LLMBackbone, Optional[PreTrainedTokenizerBase]]:
    """Return dummy LLM backbone and tokenizer"""
    if llm_backbone_id in LLM_BACKBONES:
        llm_cfg = LLM_BACKBONES[llm_backbone_id]
        return llm_cfg["cls"](), None
    return None, None
