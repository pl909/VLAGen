...
# Change these imports to be relative to the prismatic package
from ..conf import ModelConfig  # Changed from ...conf to ..conf
...
from ..overwatch import initialize_overwatch  # Changed from ...overwatch to ..overwatch
from ..vla.action_tokenizer import ActionTokenizer  # Changed from ...vla to ..vla
...
def get_llm_backbone_and_tokenizer(*args, **kwargs):
    """Dummy function to avoid LLM loading"""
    return None, None
