...
class OpenVLAForActionPrediction(PrismaticForConditionalGeneration):
    ...
    def predict_action(
        ...
        # Skip unnormalization if unnorm_key is None
        if unnorm_key is None:
            return normalized_actions
        
        # Unnormalize actions only if unnorm_key is provided
    ...
    def get_action_dim(self, unnorm_key: Optional[str] = None) -> int:
        ...
        if unnorm_key is None:
            return 7  # Default action dimension (x,y,z, roll,pitch,yaw, grasp)
