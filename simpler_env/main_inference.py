...
from simpler_env.evaluation.argparse_ import get_args
from simpler_env.evaluation.maniskill2_evaluator import maniskill2_evaluator, maniskill2_dataset_generator
...
if __name__ == "__main__":
    ...
    elif args.policy_model == "openvla" or args.policy_model == "openvla_generate_data":
        assert args.ckpt_path is not None
    ...
    if args.policy_model == "openvla_generate_data":
        success_arr = maniskill2_dataset_generator(model, args)
    else:
